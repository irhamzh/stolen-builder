              ...
              <StatusBarHorizontal color="red" size="5px" >
                <div className='d-flex justify-content-between'>
									<div className='d-flex'>
										<BsFillHeartFill color={colors.font.primary} style={{marginRight: "5px"}} size="15px"/>
                  	<Card.Subtitle>Health</Card.Subtitle>
									</div>
                  <Card.Subtitle className="text-white">{characterData.health} / {characterData.health}</Card.Subtitle>
                </div>
              </StatusBarHorizontal>
              <StatusBarHorizontal color="blue" size="5px" >
                <div className='d-flex justify-content-between'>
									<div className='d-flex'>
										<BsFillLightningFill color={colors.font.primary} style={{marginRight: "5px"}} size="15px"/>
										<Card.Subtitle>Mana</Card.Subtitle>
									</div>
                  <Card.Subtitle className="text-white">{characterData.mana} / {characterData.mana}</Card.Subtitle>
                </div>
              </StatusBarHorizontal>
            </div>
					</>
